...
export const config = {
  ...
  mcConfig: {
    smp: {
      ...
      port: parseInt(env['MINECRAFT_SMP_PORT']),
      serverId: env['MINECRAFT_SMP_SERVERID'],
      rconPort: parseInt(env['MINECRAFT_SMP_RCON_PORT']),
    ...
    cmp: {
      host: env['MINECRAFT_SERVER_IP'],
      port: parseInt(env['MINECRAFT_CMP_PORT']),
      serverId: env['MINECRAFT_CMP_SERVERID'],
      rconPort: parseInt(env['MINECRAFT_CMP_RCON_PORT']),
    ...
    cmp2: {
      host: env['MINECRAFT_SERVER_IP'],
      port: parseInt(env['MINECRAFT_CMP2_PORT']),
      serverId: env['MINECRAFT_CMP2_SERVERID'],
      rconPort: parseInt(env['MINECRAFT_CMP2_RCON_PORT']),
    ...
    copy: {
      host: env['MINECRAFT_SERVER_IP'],
      port: parseInt(env['MINECRAFT_COPY_PORT']),
      serverId: env['MINECRAFT_COPY_SERVERID'],
      rconPort: parseInt(env['MINECRAFT_COPY_RCON_PORT']),
    ...
    snapshots: {
      host: env['MINECRAFT_SERVER_IP'],
      port: parseInt(env['MINECRAFT_SNAPSHOTS_PORT']),
      serverId: env['MINECRAFT_SNAPSHOTS_SERVERID'],
      rconPort: parseInt(env['MINECRAFT_SNAPSHOTS_RCON_PORT']),
